...
HD_PWD='D:/Github/zybo-z7-10-hdmi/proj/zybo-z7-10-hdmi.runs/design_1_subset_converter_reset_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_subset_converter_reset_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_subset_converter_reset_0.tcl
